...
const CONFIG = {
  ...
  // Support both LMVIP and LIMVIP for backward compatibility
  LMVIP_USER_TOKEN: process.env.LMVIP_USER_TOKEN || process.env.LIMVIP_USER_TOKEN,
  ...
  MAINTENANCE: {
    LMVIP: process.env.LMVIP_MAINTENANCE === 'true' || process.env.LIMVIP_MAINTENANCE === 'true' || false,
  ...
  LMVIP: {
    name: 'LMVIP',
    emoji: '',
    allowedRoleId: process.env.LMVIP_ROLE_ID || process.env.LIMVIP_ROLE_ID || '1438065941240873022',
    price: parseInt(process.env.LMVIP_PRICE || process.env.LIMVIP_PRICE) || 25000,
    sellerServer: {
      channelId: process.env.LMVIP_CHANNEL_ID || process.env.LIMVIP_CHANNEL_ID || '1422529696641449994',
      messageId: process.env.LMVIP_MESSAGE_ID || process.env.LIMVIP_MESSAGE_ID || '1431928625959010375',
      buttons: {
    ...
    yourServer: {
      channelId: process.env.LMVIP_YOUR_CHANNEL_ID || process.env.LIMVIP_YOUR_CHANNEL_ID || '1438015124337332264'
    },
    colors: {
      primary: 0x32CD32,
      secondary: 0x7FFF00,
...
if (!CONFIG.LMVIP_USER_TOKEN || !CONFIG.ATVIP_USER_TOKEN || !CONFIG.BOT_TOKEN) {
  ...
  console.error('Please set: LMVIP_USER_TOKEN (or LIMVIP_USER_TOKEN), ATVIP_USER_TOKEN, BOT_TOKEN');
  process.exit(1);
}
